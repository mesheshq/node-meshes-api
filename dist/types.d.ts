...
export declare class MeshesApiClient {
     ...
     */
    get<T = unknown>(path: string, options?: MeshesOptionalRequestOptions): Promise<T>;
    /**
     ...
     */
    get<T = unknown>(path: string, options: MeshesOptionalRequestOptions | undefined, done: CallbackFunction<T>): undefined;
    /**
     ...
     * @returns {Promise<T>} - Request promise
     */
    post<T = unknown, B = unknown>(path: string, body: B, options?: MeshesOptionalRequestOptions): Promise<T>;
    /**
     ...
     * @returns {undefined} - Undefined when a callback is provided
     */
    post<T = unknown, B = unknown>(path: string, body: B, options: MeshesOptionalRequestOptions | undefined, done: CallbackFunction<T>): undefined;
    /**
     ...
     * @returns {Promise<T>} - Request promise
     */
    put<T = unknown, B = unknown>(path: string, body: B, options?: MeshesOptionalRequestOptions): Promise<T>;
    /**
     ...
     * @returns {undefined} - Undefined when a callback is provided
     */
    put<T = unknown, B = unknown>(path: string, body: B, options: MeshesOptionalRequestOptions | undefined, done: CallbackFunction<T>): undefined;
    /**
     ...
     * @returns {Promise<T>} - Request promise
     */
    patch<T = unknown, B = unknown>(path: string, body: B, options?: MeshesOptionalRequestOptions): Promise<T>;
    /**
     ...
     * @returns {undefined} - Undefined when a callback is provided
     */
    patch<T = unknown, B = unknown>(path: string, body: B, options: MeshesOptionalRequestOptions | undefined, done: CallbackFunction<T>): undefined;
    /**
     ...
     * @returns {Promise<T>} - Request promise
     */
    delete<T = unknown>(path: string, options?: MeshesOptionalRequestOptions): Promise<T>;
    /**
     ...
     * @returns {undefined} - Undefined when a callback is provided
     */
    delete<T = unknown>(path: string, options: MeshesOptionalRequestOptions | undefined, done: CallbackFunction<T>): undefined;
}
/**
 * Meshes API Error
 */
